...
var Xe = (e) =>
  ...
  be = (e) =>
    Object.assign(ce(e), {
      between: (r, t) =>
        be(j(e, ((n, i) => I((o) => Ee(o) && n <= o && i >= o))(r, t))),
  ...
  qe = (e) =>
    Object.assign(ce(e), {
      between: (r, t) =>
        qe(j(e, ((n, i) => I((o) => $e(o) && n <= o && i >= o))(r, t))),
...
function Br(
  ...
  return (
    Qo(n?.path, r) || (i = Uo(r)),
    !n && !i && zn("No Environment variables loaded"),
            ...
            u < 0
              ? ((de = E[0]),
                ...
                u == -1 &&
                  ((_ = E.length),
                  (u = r(O, E, Y, _)),
                  u < 1 && (m++, t(E, Y < _ ? cr : O, _, l))),
                (_ = E.length))
              : u === 0 && (m++, (E = [0])),
            (C[p++] = m),
            u && E[0] ? (E[_++] = z[U] || 0) : ((E = [z[U]]), (_ = 1));
      ...
      if (!this.engine) {
        ...
        try {
          ...
          throw typeof n == "string"
            ? t
            : new S(n.message, this.config.clientVersion, n.error_code);
        }
      }
    }
    logger(r) {
