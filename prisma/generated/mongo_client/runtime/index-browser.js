...
function B(e, n) {
  ...
  if (
    ...
    (s = N.e),
      t > 1 ? ((N = new C("0." + i)), s++) : (N = new C(t + "." + i.slice(1)));
  } else
    return (
...
function In(e) {
  var n,
    ...
    u = [];
  if (
    (e === void 0 ? (e = this.precision) : R(e, 1, V),
    (t = Math.ceil(e / m)),
    this.crypto)
  )
