...
const config = {
  generator: {
    ...
    output: {
      value:
        "C:\\Users\\grube\\OneDrive\\Documentos\\apollofyBE\\MovieHub-FullStack\\prisma\\generated\\mongo_client",
      fromEnvVar: null,
    },
    config: {
      engineType: "library",
  ...
  inlineSchemaHash:
    "722ebb7aaddad1ac1267b891c541a292e309a482c0cdb5d215ac1fa34b96537e",
  copyEngine: true,
};
...
path.join(
  process.cwd(),
  "prisma/generated/mongo_client/libquery_engine-darwin-arm64.dylib.node",
);
// file annotations for bundling tools to include these files
